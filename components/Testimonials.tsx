...
const reviews: Testimonial[] = [
  {
    ...
    content: "I actually feel confident cooking now! The 'Fat Burger Bombs' and 'Crispy Coconut Shrimp' are on repeat in our house. With 600 recipes, I never run out of ideas, which is amazing.",
    rating: 5
  },
  {
    id: 2,
    name: "James T.",
    role: "Verified Buyer",
    content: "Honestly, the value blew me away. 600 recipes for this price? Unreal. I’ve even stopped ordering takeout because the 'Thai Beef Stir-Fry' tastes better than my favorite restaurant!",
    rating: 5
  },
  {
    id: 3,
    ...
    content: "This book fixed my biggest problem: boring, healthy meals. The 'Air Fried Cod with Basil Vinaigrette' and 'Blueberry Overload French Toast' got me excited to cook again.",
    rating: 5
  }
];
